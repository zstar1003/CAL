...
if __name__ == '__main__':
    ...
    parser.add_argument('--copy_images_folder', type=str, default="../dataset/VisDrone_part/temp/images", help='Path to the folder where selected images will be copied.')
    parser.add_argument('--copy_labels_folder', type=str, default="../dataset/VisDrone_part/temp/labels", help='Path to the folder where selected labels will be copied.')
